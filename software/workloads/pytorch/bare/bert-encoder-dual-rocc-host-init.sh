...
echo "Generating PyTorch BERT-style encoder model cases"
"${PYTHON_BIN}" scripts/export_encoder_model_cases.py --suite bert

echo "Building bare-metal dual-RoCC BERT-style encoder binary"
make clean
